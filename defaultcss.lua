return [[/* W3.CSS 2.61 by Jan Egil and Borge Refsnes. Do not remove this line */
...
.sticky {
  position: fixed;
  top: 0;
  width: calc( 100% - ( 100% - var(--headerwidth,0)*1280px )*var(--headerwidth,0) );
  height: calc( var(--headerheight,0) );
  background-size: calc( var(--headersize,10) );
